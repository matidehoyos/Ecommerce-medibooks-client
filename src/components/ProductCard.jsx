...
const ProductCard = ({ libro }) => {
  ...
  return (
    <Link href={`/product/${libro.id}`} className="w-full max-w-[280px] relative p-0 lg:p-[5px] rounded-md overflow-hidden bg-transparent lg:border lg:border-gray-400 group transition-all duration-700" aria-label="Ir a la página de detalle del producto.">
      {
        libro.descuento > 0 ? (
