...
const ProductCard = ({ libro }) => {
  ...
  return (
    <Link href={`/product/${libro.id}`} className="w-full relative p-2 border border-gray-400 rounded-md shadow-lg overflow-hidden bg-gray-100 group lg:hover:border-gray-500 lg:hover:shadow-gray-600 transition-all duration-500">
      {
        libro.descuento > 0 ? (
