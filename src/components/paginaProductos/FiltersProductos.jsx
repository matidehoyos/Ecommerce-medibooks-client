...
const FiltersProductos = ({handleCategoryChange, queryCategory, handlePriceChange, priceFilter, handleDateChange, dateFilter}) => {
    ...
    return (
        ...
        <div className='w-full md:w-[200px]'>
          <select
            id="category"
            className="w-full lg:w-[200px] px-1 lg:px-4 py-2 text-md text-gray-700 font-bold border rounded-md border-gray-400 bg-[rgba(256,256,256,.8)] focus:outline-none "
        ...
        <div className='w-full md:w-auto flex gap-2 lg:gap-4'>
          <div className='w-full md:w-[200px]'>
            <select
              id="price"
              className="w-full md:w-[200px] px-1 lg:px-4 py-2 text-gray-700 font-bold border rounded-md border-gray-400 bg-[rgba(256,256,256,.8)] focus:outline-none"
